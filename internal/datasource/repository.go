...
func (r *Repository) CreateUser(ctx context.Context, u models.User) (id int, err error) {
...
func (r *Repository) GetUserId(ctx context.Context, id int) (models.User, error) {
...
func (r *Repository) UpdateUser(ctx context.Context, id int, u models.User) error {
